...
class TestVarasto(unittest.TestCase):
    ...
    def test_lisaa_varastoon_alle_0(self):
        self.assertAlmostEqual(self.varasto.lisaa_varastoon(-1),)


    def test_str(self):
        result = str(self.varasto)
        self.assertEqual(result, "saldo = 100, vielä tilaa 0") 
